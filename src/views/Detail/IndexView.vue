    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <zoom-tool
            :skuImageList="skuInfo.skuImageList ? skuInfo.skuImageList : [{}]"
          ></zoom-tool>
          <!-- 小图列表 -->
          <image-list
            :skuImageList="skuInfo.skuImageList ? skuInfo.skuImageList : [{}]"
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleInfo in spuSaleAttrList" :key="saleInfo.id">
                ...
                <dd
                  changepirce="0"
                  v-for="saleValue in saleInfo.spuSaleAttrValueList"
                  :key="saleValue.id"
                  :class="{ active: saleValue.isChecked == 1 }"
                  @click="
                    changeActive(saleValue, saleInfo.spuSaleAttrValueList)
                  "
                >
